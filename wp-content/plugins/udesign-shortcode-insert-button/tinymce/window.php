	...
	function insertudesignSILink() {
		...
		// which tab is active ?
                if (ibMiscellaneous.className.indexOf('current') != -1) {
                        ...
                        // Pullquote2 (left)
                        if(selectedMiscellaneousShortcode == 'pullquote2_left') {
                            shortcodetext = '[pullquote2 style="left" quote="dark"]Lorem ipsum dolor sit amet nec, consectetuer adipiscing elit. Aenean commodo ligula eget dolor.[/pullquote2]';
                        }
                        // Pullquote2 (right)
                        else if(selectedMiscellaneousShortcode == 'pullquote2_right') {
                            shortcodetext = '[pullquote2 style="right" quote="dark"]Lorem ipsum dolor sit amet nec, consectetuer adipiscing elit. Aenean commodo ligula eget dolor.[/pullquote2]';
                        }
                        ...
                        // Accordion
                            ...
                            shortcodetext = '[accordion scroll_into_view="no"]<br />' +
                        ...
                        // Tabs
                            ...
                            shortcodetext = '[udesign_recent_posts title="Recent Posts" category_id="1" num_posts="3" post_offset="0" num_words_limit="23" show_date_author="0" show_more_link="0" more_link_text="Read more" show_thumbs="1" remove_thumb_frame="0" thumb_frame_shadow="0" default_thumb="1" post_thumb_width="100" post_thumb_height="80"]';
                        }
                        ...
                        else if(selectedMiscellaneousShortcode == 'safe_email') {
                            shortcodetext = '[safe_email]john.doe@example.com[/safe_email]';
                        }
			...
			var ibButtonTarget = document.getElementById('ib-button-target-blank').checked;
                        ...
                        if(selectedButton == '1') {
                            shortcodetext = '[flat_button text="Flat Button..." title="Flat Button" url="#" padding="10px 20px" bg_color="#FF5C00" border_color="#FF5C00" border_width="1px" text_color="#FFFFFF" text_size="14px" align="'+ibButtonAlignmen+'" '+ibButtonTargetHTML+']';
                        } else if(selectedButton == '2') {
                            shortcodetext = '[flat_button text="Flat Button..." title="Flat Button" url="#" padding="10px 20px" bg_color="transparent" border_color="#FF5C00" border_width="1px" text_color="#000000" text_size="14px" align="'+ibButtonAlignmen+'" '+ibButtonTargetHTML+']';
		...
		if(window.tinyMCE) {
                        window.tinyMCE.get(window.tinyMCE.activeEditor.id).execCommand('mceInsertContent', false, shortcodetext);
...
<body id="link" onload="tinyMCEPopup.executeOnLoad('init();');" style="display: none">
    ...
    <div style="margin: 5px 12px; text-align: right;"><h4><a href="http://www.universallyacclaimed.com/wp-themes/u-design/?page_id=59" target="_blank">Preview examples</a></h4></div>
    
    <!-- <form onsubmit="insertLink();return false;" action="#"> -->
    <form name="udesignShortcodeInsert" action="#" style="margin: 10px;">
        <div class="tabs">
            <ul>
	...
	<div class="panel_wrapper"  style="height:180px; padding: 5px 20px;">
		...
		<div id="ib-miscellaneous-panel" class="panel current">
                    ...
                    <select name="ib-miscellaneous-shortcode" id="ib-miscellaneous-shortcode">
                            ...
                            <option value="pullquote2_left">Pullquote2 (left)</option>
                            <option value="pullquote2_right">Pullquote2 (right)</option>
                            ...
                            <option value="safe_email">Safe Email Address</option>
                    </select>
		</div>
		...
		<!-- Buttons panel -->
                <div id="ib-buttons-panel" class="panel">
                    ...
                    <select name="ib-selected-button" id="ib-selected-button" onChange="toggleButtonSize(this.value);">
                            <option value="1">Flat Button</option>
                            <option value="2">Flat Button (Transparent)</option>
                            <option value="3">Small Button (Light)</option>
                            <option value="4">Small Button (Dark)</option>
                            <option value="5">Large Button (Light)</option>
                            <option value="6">Large Button (Dark)</option>
                            <option value="7">Round Button(Light)</option>
                            <option value="8">Round Button(Dark)</option>
                            <option value="9">Custom Button</option>
                            <option value="10">Read more (link)</option>
                    </select>
                    <br /><br />
                    ...
                    <br /><br />
                    <div id="ib-button-size-wrapper" style="display: none;">
                ...
                <script type="text/javascript">
                    // <![CDATA[
                    function toggleButtonSize(optionValue) {
                        if(optionValue == 9) {
                            document.getElementById("ib-button-size-wrapper").style.display = 'block';
                        } else {
                            document.getElementById("ib-button-size-wrapper").style.display = 'none';
                        }
                    }
                    // ]]>
                </script>
        ...
        <div class="mceActionPanel" style="margin-top: 10px;">
		<div style="float: left">
                    <input type="button" style="height: 30px; line-height:27px; padding:0 12px 2px;" id="cancel" name="cancel" value="<?php _e("Cancel", 'udesignSI'); ?>" onclick="tinyMCEPopup.close();" />
		</div>

		<div style="float: right">
			<input type="submit" style="height: 30px; line-height:27px; padding:0 12px 2px;" id="insert" name="insert" value="<?php _e("Insert", 'udesignSI'); ?>" onclick="insertudesignSILink();" />
		</div>
	</div>
    </form>
</body>
