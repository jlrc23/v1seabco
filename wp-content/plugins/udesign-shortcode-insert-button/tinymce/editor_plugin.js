		...
		init : function(ed, url) {
			...
			ed.addCommand('mceudesignShortcodeInsert', function() {
				ed.windowManager.open({
					file : url + '/window.php',
					width : 620 + ed.getLang('udesignShortcodeInsert.delta_width', 0),
					height : 330 + ed.getLang('udesignShortcodeInsert.delta_height', 0),
					inline : 1
				}, {
			...
			ed.addButton('udesignShortcodeInsert', {
				title : 'U-Design Shortcode Insert Button',
